...
export default function Image() {
  ...
  const handleGenerate = useCallback(async () => {
    ...
    fullPrompt = businessName.trim()
      ? `Design a high-quality, professional poster for a business named "${businessName.trim()}". The poster should visually represent: ${prompt.trim()}. Use a clean, modern layout suitable for marketing purposes.`
      : `Design a high-quality, professional business poster that visually represents: ${prompt.trim()}. Use a clean, modern layout suitable for marketing purposes.`;
    ...
    <div className="min-vh-100 d-flex align-items-center justify-content-center bg-black text-white p-4">
      <div className="bg-dark p-5 rounded-4 shadow-lg w-100" style={{ maxWidth: '768px' }}>
        <div className="text-center mb-5">
          ...
          <p className="text-white-50">Describe your business ad image and click "Generate".</p>
        </div>
