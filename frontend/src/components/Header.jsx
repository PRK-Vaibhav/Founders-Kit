  ...
  return (
    <header className="header">
      ...
      <nav className="nav">
        ...
        <a style = {{cursor: 'pointer'}} onClick={() => navigate('/Login')} className="nav-link">Sign In</a>
        <a style = {{cursor: 'pointer'}} onClick={() => navigate('/Register')} className="nav-link">Register</a>
      </nav>
    </header>
  );
}
